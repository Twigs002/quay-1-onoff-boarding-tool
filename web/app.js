...
(() => {
  ...
  // contract. It also drives who attends induction: Broker Assistant + Lead Nurturer do; Fancy
  // Caller + Relationship Manager do not (backend: _aquaInductionEligible_ in Provisioning.js).
