  ...
  var body =
    ...
    '<tr><td style="padding:32px 40px 8px">' +
      ...
      '<table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin:14px 0 0;border:1px solid #DCE8F6;border-radius:12px;background:#F5F8FD"><tr>' +
        ...
        '<div style="font-size:15px;font-weight:700;color:#17223D;padding-top:3px">&#128205; Ground Floor, 200 On Main, 200 Main Rd, Claremont</div></td>' +
        '<td valign="middle" align="right" style="padding:15px 18px 15px 6px;white-space:nowrap"><a href="https://www.google.com/maps/dir/?api=1&destination=200+On+Main,+200+Main+Road,+Claremont,+Cape+Town" style="display:inline-block;text-decoration:none;background:#3D5BA6;color:#ffffff;font-size:13px;font-weight:700;padding:11px 16px;border-radius:9px">Get directions &nbsp;&rarr;</a></td></tr></table>' +
      // Holy grail
